...
const STATION_FORMS: PluralForms = ['станция', 'станции', 'станций']
const TRANSFER_FORMS: PluralForms = ['пересадка', 'пересадки', 'пересадок']
const VARIANT_FORMS: PluralForms = ['вариант', 'варианта', 'вариантов']

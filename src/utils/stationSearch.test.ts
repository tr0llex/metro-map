...
describe('ранжирование подсказок станций', () => {
  ...
  it('нечувствительно к регистру и к «ё»', () => {
    ...
    // В данных название написано через «е» — нормализация должна работать
    // в обе стороны, а не только «ввод без ё → данные с ё».
    expect(firstTitle('щёлковская')).toBe('Щелковская')
  })

...
/**
 * Множитель поверх естественного стартового фита — лёгкое приближение,
 * чтобы схема не казалась вписанной впритык. Общий для обеих раскладок:
 * на мобильном поверх «заполнить экран» (coverScaleFor), на широкой поверх
 * «вся схема целиком» (fitScaleFor).
 */
export const INITIAL_ZOOM_BOOST = 1.15
